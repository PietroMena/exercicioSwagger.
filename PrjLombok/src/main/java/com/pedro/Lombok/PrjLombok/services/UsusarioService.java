package com.pedro.Lombok.PrjLombok.services;
...
import com.pedro.Lombok.PrjLombok.repositories.UsuarioRepoitorio;

@Service
public class UsusarioService {

	private final UsuarioRepoitorio userRepository;

	@Autowired
	public UsusarioService(UsuarioRepoitorio userRepository) {
